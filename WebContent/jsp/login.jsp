	...
	<div class="head">
    	<div class="headMain">
         ...
         <div class="headNav">
            ...
            <a href="#" target="_blank"><li>资讯</li></a>
            <a href="#" target="_blank"><li>资源共享</li></a>
            <a href="#" target="_blank"><li>二手市场</li></a>   
            <a href="#" target="_blank"><li>二手市场</li></a>     	
         </div>	
        </div>     
    </div>
    ...
    <div class="login_middleSet">
        ...
        <div class="login_middleRight">
        	<div class="login-part">
              <h3>帐号登录</h3>
             <form id="fm1" method="post" action="LoginServlet">
...
<div style="background:#101010; width:auto; height:30px;">
	<li style="color:#586666; text-align:center; width:300px; margin:auto; line-height:30px;">CopyRight </li>
</div>
